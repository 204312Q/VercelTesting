export const nourishMenuPool = {
    0: {
        lunchDishes: [
            {
                english: "Pig's Trotter with Ginger, Vinegar and Egg",
                chinese: "猪脚醋",
            },
            {
                english: "Sheng Yu Fillet with Red and Green Capscium",
                chinese: "生鱼片炒青红椒",
            },
            {
        ...
        dinnerDishes: [
            {
                english: "Nutritious Carrot and Corn Pork Rib Soup",
                chinese: "罗宋排骨汤",
            },
            {
    ...
    1: {
        ...
        dinnerDishes: [
            ...
            {
                english: "Three Cup Chicken with Glutinous Rice Wine",
                chinese: "三杯鸡",
            },
            {
                english: "Stir Fried Lady Finger with Tumeric and Egg",
                chinese: "秋葵炒肉碎蛋，黄姜",
            },
            {
                english: "Wok Fried Huai Shan Noodle with Egg",
                chinese: "锅炒淮山面与蛋",
            },
        ],
    },
    2: {
        lunchDishes: [
            {
                english: "Amaranth Green with XO Fish Fillet Soup",
                chinese: "苋菜XO鱼片汤",
            },
            { english: "Baked Herbal Chicken", chinese: "烤药材鸡" },
            {
                english: "Home Made Beancurd with Minced Pork Sauce",
                chinese: "自制豆腐与肉碎酱汁",
            },
            {
                english: "Stir Fried Rice Vermicelli with Egg and Ginger",
                chinese: "炒米粉与蛋，姜丝",
            },
        ],
        dinnerDishes: [
            {
                english: "Nourishing and Beautifying Black Chicken Soup",
                chinese: "人参黑鸡汤",
            },
            {
                english: "Lean Meat with Sesame Sauce and Egg Omelette",
                chinese: "麻油瘦肉，煎蛋",
            },
            {
                english: "Stir Fried Broccoli with Fishmaw",
                chinese: "鱼鳔炒青菜花与红萝卜",
            },
    ...
    3: {
        lunchDishes: [
            {
                english: "Snow Fungus, Mushroom Chicken Soup",
                chinese: "银耳香菇鸡汤",
            },
            {
                english: "Grilled Salmon with Apple Mirin Sauce",
                chinese: "烤三文鱼与苹果味􄷰",
            },
    ...
    4: {
        lunchDishes: [
            {
                english:
                    "Pork Rib, Pig's Stomach with Lotus Seed Ginkgo Peppercorn Soup",
                chinese: "白果莲子猪肚排骨汤",
            },
            {
            ...
            {
                english: "Stir Fried Shanghai Green with Scallop",
                chinese: "炒上海青与干贝",
            },
        ...
        dinnerDishes: [
            {
                english: "Tonify Bei Sha Shen, Yu Zhu Pork Rib Soup",
                chinese: "北沙参玉竹排骨汤",
            },
    ...
    5: {
        lunchDishes: [
            ...
            {
                english: "Mei Kuei Lu Chicken with Tau Kwa",
                chinese: "玫瑰露鸡与豆干",
            },
            {
    ...
    6: {
        lunchDishes: [
            ...
            {
                english: "Stewed Cordyceps Militaris Chicken",
                chinese: "冬虫草花炖鸡",
            },
        ...
        dinnerDishes: [
            {
                english: "Double Strength Ba Zhen Black Chicken Soup",
                chinese: "上品八珍黑鸡汤",
            },
    ...
    7: {
        lunchDishes: [
            ...
            {
                english: "Sweet & Sour Fish Top with Capsicum",
                chinese: "酸甜鱼与青红椒",
            },
            {
        ...
        dinnerDishes: [
            ...
            {
                english: "Braised Beancurd with Tomato Minced Meat",
                chinese: "番茄炒肉碎豆腐",
            },
            { english: "Stir Fried Nai Bai with Scallop", chinese: "干贝炒奶白" },
            {
                english: "Turmeric Fried Rice with Long Bean",
                chinese: "黄姜长豆炒饭",
            },
        ],
    },
    8: {
        lunchDishes: [
            ...
            {
                english: "Stir Fried Kai Lan with Pig's Liver",
                chinese: "猪肝炒本地芥兰",
            },
        ...
        dinnerDishes: [
            {
                english: "Double Boiled Black Chicken D.O.M Soup",
                chinese: "法国廊酒炖黑鸡汤",
            },
            {
                english: "Stir Fried Lean Meat with Red and Green Capsicum",
                chinese: "青红椒炒瘦肉",
            },
            {
    ...
    9: {
        ...
        dinnerDishes: [
            {
                english:
                    "Double Boiled Lotus Root, Peanut & Dried Tangerine Peel Pork Rib Soup",
                chinese: "莲藕花生排骨汤",
            },
            {
                english: "Steamed Herbal Chicken with Black Fungus",
                chinese: "蒸药材鸡与黑木耳",
            },
            {
    ...
    10: {
        ...
        dinnerDishes: [
            ...
            { english: "Red Wine Stewed Chicken", chinese: "法式红酒􃭦鸡" },
            {
    ...
    11: {
        lunchDishes: [
            ...
            { english: "Egg Fried Rice 蛋", chinese: "蛋炒饭" },
        ],
        dinnerDishes: [
            {
                english: "Four Herbs Snow Fungus Chicken Soup",
                chinese: "四物银耳鸡汤",
            },
            {
                english: "Braised Fu Zhou Rice Wine Fish Fillet",
                chinese: "福州红糟鱼片",
            },
            {
    ...
    12: {
        lunchDishes: [
            ...
            {
                english: "Stir Fried Sweet Peas with Sea Cucumber",
                chinese: "甜豆炒海参",
            },
            { english: "Fragrant White Rice", chinese: "白米饭" },
        ],
        dinnerDishes: [
            {
                english: "X.O Fishsoup with Shanghai Green",
                chinese: "X.O 上海青鱼片汤",
            },
            {
            ...
            {
                english: "HK Chye Sim With Superior Soya Sauce",
                chinese: "酱油香港菜心",
            },
            {
                english: "Wok Fried Carrot Noodle with Egg",
                chinese: "锅炒萝卜面与蛋",
            },
        ],
    },
    13: {
        lunchDishes: [
            ...
            {
                english: "Chicken Stew with Black Mushroom and Chestnut",
                chinese: "鸡肉炒板栗黑香菇",
            },
            {
                english: "Stir Fried HK Kai Lan with Superior Soya Sauce",
                chinese: "酱油汁炒香港芥兰",
            },
            { english: "Mixed Brown Rice", chinese: "糙米饭" },
        ],
        dinnerDishes: [
            {
                english: "Nourishing & Beautifying Black Chicken Soup",
                chinese: "人参黑鸡汤",
            },
    ...
    14: {
        lunchDishes: [
            ...
            {
                english: "Stir Fried Snow Peas with Lotus and Ginkgo Nut",
                chinese: "荷兰豆炒莲藕白果",
            },
            { english: "Mixed Brown Rice", chinese: "糙米饭" },
        ],
    ...
    15: {
        lunchDishes: [
            ...
            {
                english: "Stir Fried Chayote with Black Mushroom",
                chinese: "香菇炒佛手瓜",
            },
            {
    ...
    16: {
        lunchDishes: [
            ...
            {
                english: "Sitr Fried Amarath Green with Sliver Fish",
                chinese: "炒苋菜与脆银鱼",
            },
            { english: "Japanese Rice", chinese: "日本米饭" },
        ],
        dinnerDishes: [
            ...
            {
                english: "Stir Fried Lean Meat with Pig's Kidney",
                chinese: "瘦肉炒猪腰",
            },
            {
    ...
    17: {
        lunchDishes: [
            {
                english: "Pumpkin, Red Bean Lean Meat Soup",
                chinese: "金瓜红豆瘦肉汤",
            },
            {
                english: "Three Cup Chicken with Glutinous Rice Wine",
            ...
            {
                english: "Home Made Beancurd with Minced Meat Sauce",
                chinese: "自制豆腐与肉碎",
            },
            { english: "Fragrant White Rice", chinese: "白米饭" },
        ],
    ...
    18: {
        lunchDishes: [
            {
                english: "Pig's Stomach with Chicken Peppercorn Soup",
                chinese: "猪肚鸡肉胡椒汤",
            },
            {
        ...
        dinnerDishes: [
            ...
            {
                english: "Braised Chicken with Fu Zhou Rice Wine",
                chinese: "福州红糟鸡",
            },
            {
                english: "Stir Fried Spinach with Black Fungus and Wolfberry",
            ...
            { english: "Mixed Brown Rice 糙米饭", chinese: "糙米饭" },
        ],
    },
    19: {
        lunchDishes: [
    ...
    20: {
        lunchDishes: [
            {
                english: "Amaranth Green with X.O Fish Fillet Soup",
                chinese: "苋菜X.O鱼片汤",
            },
            {
            ...
            {
                english: "Spinach Mushroom Tomato Omelette",
                chinese: "菠菜香菇番茄煎蛋",
            },
            { english: "Mixed Five Grain Rice", chinese: "五谷米" },
        ],
        dinnerDishes: [
            ...
            {
                english: "Sweet & Sour Fish Fillet with Capsicum",
                chinese: "青红椒酸甜鱼",
            },
            {
...
export const recoveryMenuPool = {
    0: {
        lunchDishes: [
            ...
            { english: "Stir Fried Snow Peas with Chinese Yam and Black Fungus", chinese: "山药黑木耳炒荷兰豆" },
            { english: "Mixed Brown Rice", chinese: "糙米饭" },
        ],
        dinnerDishes: [
            { english: "Herbal Si Shen Chicken Soup", chinese: "四神鸡汤" },
            { english: "Stir-Fried Lean Meat with Black Fungus, Dried Lily Flower and D.O.M", chinese: "黑木耳百合干炒瘦肉" },
    ...
    1: {
        lunchDishes: [
            { english: "Milk Boosting Fish and Papaya Soup", chinese: "木瓜鱼汤" },
            { english: "Sesame Kampong Chicken with Omelette and Ginger", chinese: "麻油甘榜鸡与煎鸡蛋和姜" },
            { english: "Stir Fried Kai Lan with Pig's Liver and Wolfberry", chinese: "猪肝炒本地芥蓝" },
            { english: "Fragrant White Rice", chinese: "白米饭" },
        ],
        dinnerDishes: [
            { english: "Immunity Boosting Cordyceps Militaris Chicken Soup", chinese: "增强免疫力虫草花鸡汤" },
            { english: "Braised Pork Rib with Tofu & Shimeji Mushroom", chinese: "豆腐焖排骨,日本菇" },
            { english: "Stir Fried Hairy Gourd with Tang Hoon & Sliced Mushroom", chinese: "冬粉蘑菇片炒毛瓜" },
            { english: "Stir Fried Pumpkin Noodle with Egg", chinese: "鸡蛋炒南瓜面" },
        ],
    },
    2: {
        lunchDishes: [
            { english: "Double Boiled Lotus Peanut & Dried Tangerine Peel Pork Rib Soup", chinese: "莲藕花生陈皮炖排骨汤" },
            { english: "Steamed Threadfin With Black Fungus and Tomato", chinese: "番茄黑木耳姜片蒸鱼片" },
    ...
    3: {
        ...
        dinnerDishes: [
            { english: "Collagen Fishmaw & Hou Tou Gu Pork Rib Soup ", chinese: "胶原蛋白鱼肚猴头菇排骨汤" },
            { english: "Pan Fried Minced Meat Chinese Yam Tofu Patty", chinese: "香煎山药肉茸豆腐饼" },
    ...
    4: {
        lunchDishes: [
            ...
            { english: "HK Style Steamed Golden Snapper in Superior Soya Sauce ", chinese: " 港式蒸鱼片" },
    ...
    5: {
        lunchDishes: [
            ...
            { english: "HK Style Chye Sim with Shredded Ginger and Wolfberry", chinese: "香港菜心与姜丝枸杞" },
            { english: "Spinach Noodle with Garlic & Egg", chinese: "蒜蓉蛋菠菜面" },
        ],
        dinnerDishes: [
            { english: "White Fungus Red Carrot Chicken Soup", chinese: "白木耳红罗卜鸡汤" },
            { english: "Mirin Sauce Pork Belly Shabu with Shimeiji Mushroom 味", chinese: "味醂日本小菇与五花肉" },
            { english: "Stir Fried Sweet Peas top with Mock Kidney, Black Fungus and Wolfberries", chinese: "甜豆炒斋腰枸杞" },
            { english: "Fragrant White Rice", chinese: "白米饭" },
        ],
    },
    6: {
        lunchDishes: [
            { english: "Red Bean, Burdock Tangerine Peel Pork Rib Soup", chinese: "养身牛蒡红豆橘皮排骨汤" },
            { english: "Steamed Chawanmushi with Ginkgo Nut and Shittake Mushroom", chinese: "茶碗蒸与白菓香菇片" },
